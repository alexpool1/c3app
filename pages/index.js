  ...
  return (
    <div >
      ...
      <div class="flex justify-center my-5">
        <button class="bg-dark-green text-white rounded font-sans font-light py-2 px-4 w-3/6 lg:w-1/4 hover:bg-green-700 "
      ...
      <div class="flex justify-center my-5">
        <button class="bg-white text-gray-800 border-gray-800 border-2 outline-2 rounded font-sans font-light px-4 py-2 w-3/6 lg:w-1/4 transition-colors hover:bg-gray-100"
