...
function login() {
  ...
  return (
    <div>
      <div class="max-w-[40%] md:max-w-[20%] mx-auto">
      ...
      <div class="w-[60%] mx-auto font-sans font-normal text-sm text-dark-gray my-5">
        By clicking Log in, you accept C3forMe's Terms of Service and Privacy Policy
      </div>
      <div class="flex justify-center my-5">
        <button class="bg-dark-green text-white rounded font-sans font-light py-2 px-4 w-[60%] hover:bg-green-700 "
      ...
      <div class="flex justify-center my-5">
        <button class="bg-white text-dark-gray border-dark-gray border-2 outline-2 rounded font-sans font-light px-4 py-2 w-[60%] text-sm transition-colors hover:bg-gray-100"
